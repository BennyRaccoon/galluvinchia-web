---
description: Armada, campeón invicto del Coliseo durante más de diez años y Cónsul Valiente de An'Ramoda.
---
...
![Armada](../img/artwork-minotaur.webp){ .wiki-infobox-img }

<div class="wiki-infobox-name">Armada</div>
<div class="wiki-infobox-epithet">Campeón del Coliseo · Cónsul Valiente de An'Ramoda</div>

<dl>
<dt>Rol</dt><dd>Cónsul Valiente de An'Ramoda · Campeón del Coliseo</dd>
<dt>Ubicación</dt><dd>An'Ramoda</dd>
